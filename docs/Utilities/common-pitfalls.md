...
**New Map Creation**  
Any newly created maps may be buggy as the server doesn’t have the full data. The server updates every hour (I think) or do `/trigger reload` to manually force it to update. Travelling to maps in this state could cause black screens or get stuck in the void.
