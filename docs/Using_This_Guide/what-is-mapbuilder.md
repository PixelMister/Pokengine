...
!!! note
    If you're careful, you can have multiple people editing same map in mapbuilder. As long as you're editing different areas, it shoudln't cause any issues. Issues might occur if you try editing same things at same time, where it will override the changes with whoever changed it last. Still, only do so at your own risk.
